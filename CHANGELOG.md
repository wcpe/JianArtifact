...
> v0.8.0 尚未发布；未发布段只记录当前工作树的实际变更。每条 FR 的当前状态以 `docs/PRD.md` 为准。实时复制通道已按 FR-138 整体退役，本版搬迁以一致性备份包为传输单位；真实整期验收（`docs/ROADMAP.md` §4）、版本提交、tag、远程 CI 与 Release 尚未执行。
