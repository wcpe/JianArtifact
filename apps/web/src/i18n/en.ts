...
export const en = {
  ...
  auditAction: {
    ...
    managementWriteRejected: "Management write rejected (freeze or policy)",
    repoRecheck: "Recheck upstream connection",
    repoOnline: "Toggle online state",
    assetMove: "Move artifact",
    assetRename: "Rename artifact",
    aclSet: "Set access control",
    attentionAcknowledge: "Acknowledge risk batch",
    userPassword: "Reset user password",
    tokenRevoke: "Revoke access token",
    settingsUpdate: "Update settings",
    migrationStart: "Start migration",
    migrationComplete: "Complete migration",
