...
`0.8.1` 是控制台体验收敛线（`VERSION=0.8.1-dev`）。该窗口只对「需要 spec 的净新能力」立规格；增强既有 FR 的收敛项直接登记在 `docs/PRD.md` §4.4.1。

| FR     | 规格                                                             | 主题               | 状态   |
| ------ | ---------------------------------------------------------------- | ------------------ | ------ |
| FR-139 | [`0.8.1-i18n-language-policy.md`](0.8.1-i18n-language-policy.md) | 界面语言策略与切换 | 开发中 |
